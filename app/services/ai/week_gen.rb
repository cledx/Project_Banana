class Ai::WeekGen
  ...
  def prompt_gen
    prompt = <<-PROMPT
      ...
      You need to plan a few meals for them to cook in advance to feed them for the week. Select only 4 different recipes maximum for the whole week, and spread them out between the days and do not use the same recipe more than 3 times the whole week.
